...
class HabitSoundPicker extends StatefulWidget {
  ...
  static Future<String?> show(BuildContext context, String currentSoundId) async {
    return showModalBottomSheet<String>(
      ...
      builder: (context) => _HabitSoundPickerSheet(
  ...
  @override
  State<HabitSoundPicker> createState() => _HabitSoundPickerState();
}

class _HabitSoundPickerState extends State<HabitSoundPicker> {
  @override
...
class _HabitSoundPickerSheet extends StatefulWidget {
  final String currentSoundId;

  const _HabitSoundPickerSheet({
    required this.currentSoundId,
  });

  @override
  State<_HabitSoundPickerSheet> createState() => _HabitSoundPickerSheetState();
}

class _HabitSoundPickerSheetState extends State<_HabitSoundPickerSheet> {
...
class _HabitSoundTile extends StatelessWidget {
